...
contract SphynxToken is BEP20, Manageable {
    ...
    address payable public marketingWallet =
        payable(0xbc35E325D2507004816770a5Ea65EB830F1A3259);
    address payable public developmentWallet =
        payable(0x03C97ccd557fbb26032d4D630793fA9eaA8BEd9D);

    uint256 public nativeAmountToSwap = 10000 gwei;
    ...
    constructor() public BEP20("SPHYNX BRC", "SPHYNX") {
        ...
        ISphynxRouter02 _sphynxSwapRouter = ISphynxRouter02(
            0x21086f765FcaFE6F78a76b43B207ADC7e9b529C4
        ); // mainnet
    ...
    function updateLiquidityWallet(address _liquidityWallet) external onlyManager {
    ...
    function updateShares(
        ...
        totalShares = liquidityShare.add(liquidityFeeOnSell).add(
            developmentShare
        );
