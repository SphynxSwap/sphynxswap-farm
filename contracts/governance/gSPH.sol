...
contract gSPH is IgSPH, ERC20 {
    ...
    constructor( address _sSPH)
        ERC20("Governance SPH", "gSPH", 18)
    {
     ...
     * @param _sSPH address
     */
    function migrate(address _staking, address _sSPH) external override onlyApproved {
        ...
        require(_sSPH != address(0), "Zero address found");
        sSPH = IsSPH(_sSPH);
    }
    ...
    /**
     * @notice pull index from sSPH token
     */
    ...
    /**
        @notice converts gSPH amount to SPH
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts SPH amount to gSPH
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gSPH::getPriorVotes: not yet determined");
